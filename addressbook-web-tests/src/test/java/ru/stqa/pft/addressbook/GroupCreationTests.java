...
public class GroupCreationTests {
    ...
    public void GroupCreationTests() {
        ...
        wd.findElement(By.name("group_name")).sendKeys("LPV Group 1");
        ...
        wd.findElement(By.name("group_header")).sendKeys("LPV Header 1");
        wd.findElement(By.name("group_footer")).click();
        wd.findElement(By.name("group_footer")).sendKeys("\\9");
        wd.findElement(By.name("group_footer")).click();
        wd.findElement(By.name("group_footer")).clear();
        wd.findElement(By.name("group_footer")).sendKeys("LPV Footer 1");
